...
import {MarkerDetails, NewMarkerDetails} from './MarkerDetails'
        ...
        {selectedGroup && <>
            {group.id === selectedGroup.id &&
                <InfoWindow onCloseClick={() => setSelectedGroup(null)}>
                    <MarkerDetails deleteGroup={deleteGroup} group={group} showModalWithSomeData={showModal} />
                </InfoWindow>
            }
        </>}
    </Marker>
...
const TempMarker = ({ setShowTempMarkerDetails, showTempMarkerDetails, position, onDragEnd, showModalWithSomeData }) => {
    ...
    >
        {showTempMarkerDetails && <InfoWindow onCloseClick={() => setShowTempMarkerDetails(false)}>
            <NewMarkerDetails coords={position} showModalWithSomeData={showModalWithSomeData} />
        </InfoWindow>}
    </Marker>
}
